		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>TAMSTADE CHECKER</strong></h4>
					<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://telegram.dog/@TAM_YT"></a> <br>
					<textarea rows="6" class="form-control text-center form-checker mb-2" placeholder="PUT YOUR CC HERE :>"></textarea>
					
	<br>	
<a class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-toggle="dropdown" aria-expanded="false" href="https://t.me/TAMZ_HACKING">JOIN OUR COMMUNITY </a> <br>		
...
Swal.fire({ title: "@TAM_YT", text: "FUCK YOU :(", icon: "warning", confirmButtonText: "OK", buttonsStyling: false, confirmButtonClass: 'btn btn-primary'});
...
if(total > 5000){
  Swal.fire({title: ':) DARE TO CHECK MORE THAN 5000 CC Ah, Pretty SMALL!!', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
